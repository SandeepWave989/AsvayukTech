                ...
                <Container>
                    ...
                    <div className='magento_cards'>
                        <Row className='gy-4'>
                            ...
                            <Col lg={4}>
                                <Magento_service_card cardImg={service3} cardHeading="Multi-Currency Support" cardPara="Support for multiple cryptocurrencies in a single wallet for easy management." />
                            </Col>
                            <Col lg={4}>
                                <Magento_service_card cardImg={service4} cardHeading="Mobile Crypto Wallets" cardPara="Access your digital assets on-the-go with mobile-compatible crypto wallets." />
                            </Col>
                            <Col lg={4}>
                                <Magento_service_card cardImg={service5} cardHeading="Smart Wallet Features" cardPara="Utilize advanced smart wallet features for automation and security in crypto management." />
                            </Col>
                            <Col lg={4}>
                                <Magento_service_card cardImg={service6} cardHeading="Blockchain Analytics" cardPara="Track blockchain transactions and monitor wallet performance with advanced analytics." />
                            </Col>
                        </Row>
                    </div>
                </Container>
                    ...
                    <div className="row">
                        <div className="choice pb-5">
                            ...
                            <ul>
                                ...
                                <li><span className="fw-bold h6">Ongoing Support:</span> Post-launch support to ensure seamless functionality and continuous improvement of your crypto wallet system.</li>
                            </ul>
                        </div>
                    </div>
                </div>
