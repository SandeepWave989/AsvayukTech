...
const Website_Development = () => {
    return (
        <>
           <Meta_Component
        title="Professional Website Development Company | Web Solution"
        description="Looking for a reliable website development company? We build custom, responsive websites development to your needs, grow online presence."
        canonical="https://asvayuktech.com/website-development"
       />
                    ...
                    <Row className="align-items-center">
                        <div className="col-lg-6">
                            <div className="banner_textInfo-en">
                                <Breadcrumb>
                                    ...
                                    <Breadcrumb.Item active>Website Development</Breadcrumb.Item>
                                </Breadcrumb>
                                <h1>Crafting Future-Ready Website Development for Digital Excellence</h1>
                                <p className="py-3">With Asvayuk Technologies, embark on your journey to success by creating a seamless digital masterpiece that resonates with your audience and delivers tangible results. We specialize in pioneering high-performance and transformative Web Development Services to propel your digital journey towards success.</p>
                        ...
                        <div className="col-lg-6">
                            <div className="bannerImg">
                                <img src={web_banner} alt="" width="100%" height="100%" />
                            </div>
                        </div>
                    </Row>
                </Container>
                ...
                <div className="container">
                    <div className="col-12">
                        <div className="peformance_card2_heading text-center">
                            <h2>Our Services for Website Development</h2>
                            <p className="mt-3">We meticulously design our suite of services to cater to diverse business needs, delivering top-notch Website Design and Development solutions in Chandigarh that resonate with your audience.
                            </p>
                        </div>
                        <div className="performance_card2_inner-sec mt-5">
                            <div className="row">
                                <div className="col-lg-4 pb-4">
                                    <ServicesCard ServiceCardImg={c11} cardHeading='Responsive Web Design' cardParaGraph='Craft visually stunning and adaptable websites that seamlessly adjust to all devices, ensuring optimal user experiences and boosting your online presence while maintaining brand consistency.' />
                                </div>
                                <div className="col-lg-4 pb-4">
                                    <ServicesCard ServiceCardImg={c12} cardHeading='Custom Web Development' cardParaGraph='Beyond the ordinary, our expert developers use advanced coding and frameworks to create unique, scalable, and secure websites tailored precisely to your business needs.' />
                                </div>
                                <div className="col-lg-4 pb-4">
                                    <ServicesCard ServiceCardImg={c13} cardHeading='eCommerce Development' cardParaGraph='Drive revenue growth with our eCommerce solutions. We craft secure, user-friendly online stores that captivate customers and drive conversions, ensuring a seamless shopping experience.' />
                                </div>
                                <div className="col-lg-4 pb-4">
                                    <ServicesCard ServiceCardImg={c14} cardHeading='Progressive Web Apps (PWAs)' cardParaGraph='Stay ahead with Progressive Web Apps that blend the best of web and mobile applications. Our PWAs deliver rapid, reliable, and engaging experiences that enhance user satisfaction and retention.' />
                                </div>
                                <div className="col-lg-4 pb-4">
                                    <ServicesCard ServiceCardImg={c15} cardHeading='Voice Search Optimization' cardParaGraph='Optimize your web presence for voice search to enhance discoverability and user-friendliness in voice interactions, improving accessibility and user experience.' />
                                </div>
                                <div className="col-lg-4 pb-4">
                                    <ServicesCard ServiceCardImg={c16} cardHeading='Blockchain Integration' cardParaGraph='Integrate blockchain technology into your web solutions for enhanced security, transparency, and efficiency. Asvayuk Technologies offers blockchain integration services that provide decentralized solutions tailored to your business requirements' />
                                </div>
                            </div>
                        </div>
            ...
            <Experience expTitle='Why Develop Your Website With Us?' ExpPara='As a leading Website development company in Chandigarh, Asvayuk Technologies specializes in creating fully-featured Website Design that bring your digital vision to life. Our dedication to innovation guarantees that your Website isnt just a functional tool but a technological masterpiece delivering exceptional user experiences and inspiring customers.' point1='Proven Expertise' pointPara1='With mastery of the latest frameworks, our skilled developers deliver unparalleled solutions.' point2='Adaptive Solutions' pointPara2='We specialize in crafting dynamic, future-proof solutions for evolving digital landscapes.' point3='Client-centric Approach' pointPara3='Our commitment to a customer-centric approach ensures a smooth and seamless user experience at every step.' point4='Robust Support' pointPara4='Count on our dedicated support team to ensure your digital presence is always optimized.' />
                    ...
                    <Row className="d-flex flex-column text-center">
                        <div className="main-bg w-100">
                            <div className="inside-main py-5">
                                <h1>Our Method of Specialization
                                </h1>
                                <div className="work-para mt-2">
                                    <p>
                                    Our team of expert website developers plan, design, develop, test, optimize, and launch website that redefine user experiences.
                                    </p>
                                </div>
