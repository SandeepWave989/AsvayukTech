...
function Smart_Contract_Developer_in_Chandigarh_Panchkula_Mohali() {
    return (
        <>
            <main>
                        ...
                        <Row>
                            ...
                            <Col lg={8} className='col-12'>
                                <div className="blog_card">
                                    <h2>
                                        <b>Smart Contract Developer in Chandigarh, Panchkula, Mohali</b>
                                    </h2>
...
export default Smart_Contract_Developer_in_Chandigarh_Panchkula_Mohali
